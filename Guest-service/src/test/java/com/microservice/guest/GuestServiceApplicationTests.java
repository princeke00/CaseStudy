...
class GuestServiceApplicationTests {
	...
	public void addGuestTest() {
		Guest guest=new Guest(8083100001l,"Prince",1122334455,"princeke00@gmail.com","Male","sheohar");
	...
	public void getAllGuestTest() {
		when(guestRepository.findAll()).thenReturn(Stream
				.of(new Guest(8083100001l,"Prince",1122334455,"princeke00@gmail.com","Male","sheohar"),
					new Guest(8083100002l,"kumar",667788990,"kumar@gmail.com","Male","sitamarhi"))
