...
public class ApiGatewayConfig {
	...
	/*
	 * @Bean public RouteLocator routeLocatorLogin(RouteLocatorBuilder
	 * routeLocatorBuilder) { return routeLocatorBuilder.routes() .route(p->p
	 * .path("/reservation/get") .uri("http://localhost:9003") )
	 */
